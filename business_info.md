...
- Brake inspection, pad/disc replacement, brake fluid flushes
...
- Emissions additives / fuel additives for sale — we do NOT sell them over the
  counter. If someone is worried about failing the NCT on emissions/smoke, offer
  the real fix instead: book them in for an emissions diagnostic and we sort the
  actual cause before the test.
...
- Buying cars / trade-ins — we do NOT buy cars, and we do NOT take a car in
  ...
  buying a car FROM us, do not guess: say you'll check with a colleague and log it as an
  unknown question.)
...
- Q: How long does a pre-NCT check take?
  A: Usually under an hour; we'll confirm when you book.
